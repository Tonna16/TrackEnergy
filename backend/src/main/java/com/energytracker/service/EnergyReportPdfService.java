...
public class EnergyReportPdfService {
    ...
    public byte[] generateReport(String reportType,
        ...
        try (PDDocument document = new PDDocument(); ByteArrayOutputStream out = new ByteArrayOutputStream()) {
            ...
            cursor.writeLine(18, "TrackEnergy " + capitalize(reportType) + " Energy Report");
            ...
            cursor.writeLine(11, String.format(Locale.US, "Total Cost: $%.2f", summary.getTotalCost()));
            cursor.writeLine(11, String.format(Locale.US, "Average Daily Cost: $%.2f", summary.getAverageDailyKwh()));

            cursor.spacer(8);
            cursor.writeLine(13, "Top Energy Consumers");
