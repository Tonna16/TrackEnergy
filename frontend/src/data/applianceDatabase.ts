...
export const illustrativeReferenceEstimates = {
  sourceLabel: 'EnergyIQ bundled illustrative planning assumptions',
  provenanceNotice: 'Not measured local, national, or community data.',
